...
PennState   & $\bullet$ Computer Security (A)\\
            & $\bullet$ Hardware Security (A)\\
            & $\bullet$ Operating System Design (A)\\
\\
DA-IICT     & System and Network Security (AA)\\
            & Systems software (AA)\\
            & Operating systems (AA)\\
            & Embedded Hardware Design (AA)\\
            & Formal Specification \& Verification (AA)
\end{tabular}
